...
//   },
  data() {
    return {
      imgurl_dft: "/static/imgs/empty/empty.jpg",
      imgurl: "",
      imgs: [
        { type: "cart", url: "/static/imgs/empty/cart.jpg" },
        { type: "search", url: "/static/imgs/empty/search.jpg" },
        { type: "other", url: "/static/imgs/empty/empty.jpg" },
      ],
    };
  },
  methods: {
