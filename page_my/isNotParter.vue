<template>
	<view class="page-wrap">
		<view class="my-wrap" style="background-image: linear-gradient(to bottom,rgb(255, 84, 84) ,#ffffff );box-shadow: x-shadow 90rpx 0 y-shadow 0 0 #ffffff ;">
			<view class="div1">
			<view class="div">
				<view style="padding-right: 63rpx;margin-top:100rpx;margin-left: 105rpx;float: left;border-right:solid;border-color:lightgrey;">
					<text class="numText">{{first}}</text><text class="point">人</text>
					<view>直推人数</view>
				</view>
				<view style="margin-top:100rpx;margin-right: 105rpx;float:right;">
					<text class="point">￥</text>
					<text style="color: rgb(255, 84, 84);font-size: 21px;">{{this.config.price}}</text>
					
					<view>支付金额</view>
				</view>
				<image src="/static/imgs/112.jpg" mode="aspectFit" style="margin-top: -175rpx;width: 600rpx;" >
			</view>
			
			</view>
		</view>
		<view @click=" toCz" class="page-btn-wrap">
			<view class="page-btn" style="margin-top: 200rpx;width: 600rpx;">
				<text>支付</text>
			</view>
		</view>
		<view class="ruler">
	...
	export default {
		...
		methods: {
			...
			toCz() {
				...
				this.$util.redirectTo('/pages/my/cz-parter');
			},
			toTx() {
				if (!this.$util.checkLogin()) {
					this.$util.redirectTo('/pages/login/login', undefined);
