<template>
  <view class="page-wrap">
    <cover-view class="n-tabs-wrapper">
      <cover-view class="n-tabs-tab-wrapper" @click="switchTab(0)"
        ><cover-view v-bind:class="{ 'n-tabs-tab--active': cashType == 0 }"
          >全部</cover-view
        ></cover-view
      >
      <cover-view class="n-tabs-tab-wrapper" @click="switchTab(1)"
        ><cover-view v-bind:class="{ 'n-tabs-tab--active': cashType == 1 }"
          >待发货</cover-view
        ></cover-view
      >
      <cover-view class="n-tabs-tab-wrapper" @click="switchTab(2)"
        ><cover-view v-bind:class="{ 'n-tabs-tab--active': cashType == 2 }"
          >待收货</cover-view
        ></cover-view
      >
      <cover-view class="n-tabs-tab-wrapper" @click="switchTab(3)"
        ><cover-view v-bind:class="{ 'n-tabs-tab--active': cashType == 3 }"
          >已完成</cover-view
        ></cover-view
      >
    ...
    >
      ...
      >
        <view v-if="list.length > 0" class="list-body order-list">
          <view
            @click="toOrderDetail(item, index)"
            class="order-item"
          ...
          >
            ...
            <view v-if="item.order_status == 2" class="order-control-wrap">
              <view
                @click.stop="receiptClick(item)"
                class="order-control-btn receipt-btn"
              >
                <text>签收</text>
              </view>
            </view>
...
export default {
  ...
  methods: {
    ...
    async getOrderList() {
      let res = await getMallOrderList(this.searchParam);
