	...
	<view class="my-promotion">
		<view class="header">
			<view class="name acea-row row-center-wrapper">
				...
				<!-- <view class="record" style="float: right; margin-top: -60px;" @click="goCashRecord()">
					提现记录
					<text class="iconfont icon-xiangyou"></text>
				</view> -->
			</view>
			<view class="num">{{ Number(userInfo.point) || 0 }}</view>
			<!-- <view class="num">{{ userInfo.point || 0 }}</view> -->
			<view class="profit acea-row row-between-wrapper">
				<view class="item" style="float: left;">
					<view>昨日收益</view>
					<view class="money">{{ lastDayCount||0 }}</view>
				</view>
				<view class="item" style="float: right;">
					<view>累积已提</view>
					<view class="money">{{ extractCount||0 }}</view>
				</view>
			</view>
		</view>
		<view class="list acea-row row-between-wrapper">
			...
			<!-- <view class="item acea-row row-center-wrapper row-column" style="float: left; text-align: center;" @click="goCommissionDetails()">
				<view style="margin-top: 60rpx;">
...
<script>
	...
	export default {
		...
		methods: {
			...
			goCommissionDetails() {
				uni.navigateTo({
					url:'/pages/my/CommissionDetails'
				})
			},
			goPromoterOrder() {
			...
			getIntegral() {
				// commissionApi().then(res => {
				// 	this.commissionCount = res.data.num
				// })
			},
			getInfo() {
				// commission().then(res => {
				// 	this.lastDayCount = res.data.lastDayCount
				// 	this.extractCount = res.data.extractCount
				// })
			},
			toCash: function() {
				this.$yrouter.push({
