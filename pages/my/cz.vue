		...
		<view class="czmain">
			<view class="cztop">
				...
				<view class="czyebox">
					...
					<input type="digit" focus class="czye" v-model="price" @input="IntInput" />
					<view class="uni-btn-v uni-common-mt">
						<button class="onstep" @click="requestPayment(usermoney)">提交</button>
					</view>
				</view>
			</view>
		</view>
...
<script>
	import {
		orderBalanceCreateApi,
		orderPayApi
	} from '@/api/tuanApi.js';
	import {
		Weixin
	} from '@/static/js/wx-jssdk.js';
